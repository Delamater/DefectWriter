...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function validateOtherTextBox(event, args) {
            var textbox = document.getElementById('<%= txtCriticalHighReason.ClientID %>').value;
            if (args.Value == '3' || args.value == '4')
    ...
    <asp:CheckBox ID="chkIsWorkaroundAcceptable" runat="server" 
        Text="Workaround Acceptable" Checked="True" AutoPostBack="True" OnCheckedChanged="chkIsWorkaroundAcceptable_CheckedChanged" />
            ...
            <td class="auto-style2">
                <asp:RequiredFieldValidator ID="rfvWhyIsWorkaroundNotAcceptable" runat="server" ControlToValidate="txtWorkaroundNotAcceptableReason" ErrorMessage="State a reason why the workaround is not acceptable" ForeColor="Red">***</asp:RequiredFieldValidator>
                </td>
        </tr>
        <tr>
            <td colspan="2">
